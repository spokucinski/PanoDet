...
# # YOLOv5 Experiments
# v5_datasets_to_test = []
# for root, dirs, files in os.walk(v5_datasets_path):
#     for file in files:
#         if file.endswith(".yaml"):
#             v5_datasets_to_test.append(os.path.join(root, file))
#
...
#
#                     if not os.path.exists(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Train')):
#                         os.makedirs(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Train'))
#                     done_trainings = os.listdir(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Train'))
#                     if run_name not in done_trainings:
#                         train_cmd = ['python', f'{yolov5_train_path}',
#                                f'--project={results_path}/YOLOv5/{tested_dataset_name}/Train',
#                                f'--name={run_name}',
...
#
#                     if not os.path.exists(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Test')):
#                         os.makedirs(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Test'))
#                     done_tests = os.listdir(os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Test'))
#                     if run_name not in done_tests:
#                         best_model = os.path.join(results_path, 'YOLOv5', tested_dataset_name, 'Train', run_name, 'weights', 'best.pt')
#                         test_cmd = ['python',
#                                     yolov5_val_path,
#                                     f'--task=test',
#                                     f'--project={results_path}/YOLOv5/{tested_dataset_name}/Test',
#                                     f'--name={run_name}',
#                                     f'--data={tested_dataset}',
#                                     f'--img={image_size}',
        ...
        for image_size in image_sizes:
            for epoch_size in epochs:
                for batch_size in batch_sizes:
                    ...
                    # Although YOLOv8 implements AutoBatch
                    # it may cause local issues. Use with care!
                    if batch_size == -1:
                        continue
